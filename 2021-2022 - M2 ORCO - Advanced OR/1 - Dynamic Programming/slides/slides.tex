...
\begin{frame}
  ...
  Every observation $j$ has a meridian $m_j^i \in \interval[open right]{r_j}{d_j}$ which is a \alert{mandatory instant} of the observation.
\end{frame}
...
\begin{frame}
  ...
  \begin{block}{Property 1}
    There exists an optimal solution in which selected observations are scheduled in non-decreasing order of their mandaory instant.
  \end{block}
  ...
  \onslide<5>{%
    \begin{block}{Property 2}
      Let a subset $\cal N' \subset N$ and an observation $j_\text{max}$ such that $d_{j_\text{max}} = \max_{j \in \cal N'} d_j$.
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \onslide<5>{%
        ...
        \node[draw=black, thick, circle, fill=cyan, label=below:{(3,2,3)}] (N1211) at (1,-3) {};
        \node[draw=black, thick, circle, fill=cyan, label=below:{(3,4,6)}] (N1212) at (3,-3) {};
      ...
      \onslide<6->{%
        ...
        \node[draw=black, thick, circle, label=below:{(3,2,3)}] (N1211) at (1,-3) {};
        \node[draw=black, thick, circle, label=below:{(3,4,6)}] (N1212) at (3,-3) {};
        \draw [thick, draw=black, ->] (N121) -- (N1211);
        \draw [thick, draw=black, ->] (N121) -- (N1212);
...
\begin{frame}
  ...
  Let two nodes $n_1 = (j_1, w_1, p_1)$ and $n_2 = (j_2, w_2, p_2)$.
  If
  \begin{displaymath}
